function CodeDefine() { 
this.def = new Array();
this.def["ert_main.c:Factorial_ForLoop_M_"] = {file: "ert_main_c.html",line:23,type:"var"};
this.def["ert_main.c:Factorial_ForLoop_MPtr"] = {file: "ert_main_c.html",line:24,type:"var"};
this.def["ert_main.c:Factorial_ForLoop_DW"] = {file: "ert_main_c.html",line:26,type:"var"};
this.def["ert_main.c:Factorial_ForLoop_U_in1"] = {file: "ert_main_c.html",line:29,type:"var"};
this.def["ert_main.c:Factorial_ForLoop_Y_Out1"] = {file: "ert_main_c.html",line:32,type:"var"};
this.def["rt_OneStep"] = {file: "ert_main_c.html",line:46,type:"fcn"};
this.def["main"] = {file: "ert_main_c.html",line:84,type:"fcn"};
this.def["Factorial_ForLoop_step"] = {file: "Factorial_ForLoop_c.html",line:22,type:"fcn"};
this.def["Factorial_ForLoop_initialize"] = {file: "Factorial_ForLoop_c.html",line:57,type:"fcn"};
this.def["Factorial_ForLoop_terminate"] = {file: "Factorial_ForLoop_c.html",line:83,type:"fcn"};
this.def["DW_Factorial_ForLoop_T"] = {file: "Factorial_ForLoop_h.html",line:41,type:"type"};
...
var fileList = [
"ert_main_c.html","Factorial_ForLoop_c.html","Factorial_ForLoop_h.html","Factorial_ForLoop_private_h.html","Factorial_ForLoop_types_h.html","rt_defines_h.html","rtwtypes_h.html"];
